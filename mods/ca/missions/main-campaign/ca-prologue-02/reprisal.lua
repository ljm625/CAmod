...
WorldLoaded = function()
	...
	ObjectiveWipeOutVillage = USSR.AddObjective("消灭村庄守军。")
	ObjectiveDestroyBase = USSR.AddObjective("摧毁盟军基地。")
...
WarpInTeslaTanks = function(TankLocation1, TankLocation2, EffectLocation)
	...
	Trigger.AfterDelay(DateTime.Seconds(2), function()
		Media.DisplayMessage("同志们，向你们致意！苏维埃帝国果然无远弗届！", "Tesla Tank", HSLColor.FromHex("FF0000"))
